...
/**
 * Survey app Page Object Model (POM). Provides easy automated access for the
 * survey app. Contains methods for controlling the app without knowing
 * low-level details.
 */
public class AppModel {
	...
	/**
	 * Create a new POM to be controlled with the given driver.
	 * 
	...
	/**
	 * Tries submitting currently filled data
	 */
